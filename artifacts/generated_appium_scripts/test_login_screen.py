...
class TestLogin:
    ...
    "app": "C:/Users/priyanka.pattewar/Project13_CapstoneMobileTestGenerator/demo_mobile_apps/mda-2.2.0-25.apk",
    ...
    def test_login(self) -> None:
        ...
        #self.tap("xpath",'//android.widget.TextView[@content-desc="Login Menu Item"]')

        # Step 1: tap the Menu element.
        logger.info("Step 1: Tapping the Menu button")
        self.tap('resource_id', 'com.saucelabs.mydemoapp.android:id/menuIV')
        logger.info("Step 1: Menu button tapped successfully")

        # Step 2: tap the Login Menu Item element.
        logger.info("Step 2: Tapping the Login Menu Item")
        self.tap("accessibility_id","Login Menu Item")
        logger.info("Step 2: Login Menu Item tapped successfully")

        # Step 3: type the Username element.
        logger.info("Step 3: Entering username: bod@example.com")
        self.type('resource_id', 'com.saucelabs.mydemoapp.android:id/nameET', 'bod@example.com')
        logger.info("Step 3: Username entered successfully")
        ...
        logger.info("Step 4: Password entered successfully")

        # Step 5: tap the Login Button element.
        logger.info("Step 5: Tapping the Login button")
        self.tap('resource_id', 'com.saucelabs.mydemoapp.android:id/loginBtn')
        logger.info("Step 5: Login button tapped — login flow complete")
